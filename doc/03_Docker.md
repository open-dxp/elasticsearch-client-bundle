...
services:
    ...
    create_certs:
        ...
        volumes:
            - opendxp-enterprise-elastic-certs:/usr/share/elasticsearch/certs
    ...
    elastic:
        ...
        ports:
            - 9200:9200
        volumes:
            - opendxp-enterprise-elastic:/usr/share/elasticsearch/data
            - opendxp-enterprise-elastic-certs:/usr/share/elasticsearch/config/certs
        deploy:
            resources:
                limits:
                    cpus: '1'
    ...
    kibana:
        ...
        volumes:
            - opendxp-enterprise-elastic-certs:/usr/share/kibana/config/certs

volumes:
    opendxp-enterprise-elastic:
    opendxp-enterprise-elastic-certs:
```
